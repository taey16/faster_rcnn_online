...
def get_log_parsing_script():
  ...
  return dirname + '/parse_log_faster_rcnn.py'
...
def create_field_index():
  train_key = 'Train'
  test_key = 'Test'
  field_index = {train_key:{'Iters':0, train_key + ' accuracy':1, train_key + ' loss box':2, train_key + ' loss cls':3},
           test_key:{'Iters':0, test_key + ' accuracy':1, test_key + ' loss box': 2, test_key + ' loss cls':3}}
  fields = set()
...
Usage:
  ./plot_log.py chart_type[0-%s] /where/to/save.png /path/to/first.log ...
Notes:
